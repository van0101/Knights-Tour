...
public class Menu extends Thread
{
	...
	Menu()
	{
		...
		label_3.setIcon(new ImageIcon("V:\\Programs\\JAVA\\Knight Tour\\Knight Tour 2\\src\\knights\\Titile12.png"));
		...
		panel.add(label);
		label.setIcon(new ImageIcon("V:\\Programs\\JAVA\\Knight Tour\\Knight Tour 2\\src\\knights\\k14 - Copy.png"));
		label_1.setBounds(186, 0, 235, 291);
		panel.add(label_1);
		
		
		label_1.setIcon(new ImageIcon("V:\\Programs\\JAVA\\Knight Tour\\Knight Tour 2\\src\\knights\\b1.png"));
		label_2.setBounds(376, 0, 178, 291);
		panel.add(label_2);
		
		
		label_2.setIcon(new ImageIcon("V:\\Programs\\JAVA\\Knight Tour\\Knight Tour 2\\src\\knights\\b1.png"));
